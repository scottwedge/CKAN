...
### fcntion to uoload csvfile which has both resource and meta data file , api_key and api_host
...
def bulkupload(CATALOG_CSV , API_HOST, API_KEY):
	...
	for ix, record in catalog.iterrows():
	    ...
	    ### uploading metadata by cretaing data template
	    fields= []
